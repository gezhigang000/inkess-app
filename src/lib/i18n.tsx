...
const dict: Record<string, { zh: string; en: string }> = {
  ...
  'toolbar.splitView': { zh: '切换到分屏模式', en: 'Switch to Split' },
  'toolbar.previewMode': { zh: '切换到预览模式', en: 'Switch to Preview' },
  'toolbar.editMode.label': { zh: '编辑模式', en: 'Edit mode' },
  ...
  'ai.stopGeneration': { zh: '停止生成', en: 'Stop generating' },
  'ai.searchMessages': { zh: '搜索消息...', en: 'Search messages...' },
  'ai.matches': { zh: '条匹配', en: 'matches' },
  ...
  'toast.exportCancelled': { zh: '导出已取消', en: 'Export cancelled' },
  ...
  'terminal.split': { zh: '添加分屏', en: 'Add Pane' },
